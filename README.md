# Chat++ - Распределенная чат-система на Go и RabbitMQ

**Chat++** — это распределенная система обмена сообщениями с IRC-подобным интерфейсом, построенная на языке Go и брокере сообщений RabbitMQ. Система поддерживает прямую отправку сообщений между пользователями, бродкаст и автоматическое управление очередями.
